...
class TalkTimeLine extends PureComponent {
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (this.props.playId !== prevProps.playId) {
      !_.isNil(this.props.playId) && console.log('this.props.playId', this.props.playId);
  ...
  setChangeId(changeId, callback) {
    ...
    this.setState({ changeId }, () => {
      if (this.state.changeId !== this.props.changeId) {
        this.props.onChangeIdChange && this.props.onChangeIdChange(this.state.changeId);
      }
  ...
  handleChangeTag = (item, index, label, inStyle, mark) => {
    ...
    labels[value] = mark;
    console.log(mark);
    this.props.onItemChange && this.props.onItemChange({ ...item, labels });
  };
  ...
  handleChangeRoleTag = (item, index, label, inStyle, mark) => {
    ...
    role = value;
    console.log(mark);
    this.props.onItemChange && this.props.onItemChange({ ...item, role });
  };
                ...
                <ButtonSpace
                  ...
                  onClick={() => {
                    ...
                    tempDialogue = tempDialogue.map((item, indexs) => {
                      if (indexs >= index) return { ...item, id: item.id - 1 };
                      return { ...item };
                    });
              ...
              {this.props.pause && this.state.changeId == item.id && (
                <ButtonSpace
                  ...
                  onClick={() => {
                    ...
                    tempDialogue = tempDialogue.map((item, indexs) => {
                      if (indexs >= index + 1) return { ...item, id: item.id + 1 };
                      return { ...item };
                    });
                    console.log(tempDialogue);
        ...
        default:
          return (
            <Timeline.Item
              ...
              dot={running && !pause && index === dialogue.length ? <Spin /> : null}
            >
              <Card
                bordered={false}
                bodyStyle={{
